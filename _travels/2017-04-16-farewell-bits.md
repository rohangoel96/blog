...
<!-- <p class="center"><img src="{{site.baseurl}}/img/2017/4-farewell/10.jpg" alt="{{page.title}}. {{page.location}}. {{site.title}}" title="{{page.title}}"></p> -->
...
<ul class="rslides">
	...
	<li><img src="{{site.baseurl}}/img/2017/4-farewell/slider/10.jpg" alt="{{page.title}}. {{page.location}}. {{site.title}}" title="{{page.title}}"></li>
